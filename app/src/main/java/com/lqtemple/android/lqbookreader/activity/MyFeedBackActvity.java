...
public class MyFeedBackActvity extends BaseActivity {
    private static final String TAG = "MyFeedBackActvity";
    ...
    private void init() {
        titleCenterbtn.setText(getText(R.string.my_feedback));
